...
$_documentContainer.innerHTML = `<dom-module id="vaadin-dialog-layout">
  <template>
    ...
    <vaadin-dialog id="dialog" opened="{{opened}}" aria-label="[[__ariaLabel]]" no-close-on-outside-click="[[noCloseOnOutsideClick]]" no-close-on-esc="[[noCloseOnEsc]]" theme\$="[[theme]] layout">
      <template>
